...
import { AlertTriangle, LayoutDashboard, RefreshCw, Flame, ShieldAlert, LogIn } from "lucide-react";
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="rounded-2xl p-8 mb-6" style={{ background: "#ffffff", border: "1px solid #e2e8f0", boxShadow: "0 4px 24px -4px rgba(15,23,42,0.08)" }}>
            <div className="flex justify-center mb-4">
              ...
              >
                <ShieldAlert className="w-3 h-3" /> Page Error
              </span>
            </div>
            ...
            <p className="text-[14px] text-center leading-relaxed mb-8" style={{ color: "#64748b" }}>
              An error occurred while loading this section of the dashboard. Your other data is unaffected — try refreshing or return to your dashboard.
            </p>
          ...
          <div className="flex items-start gap-3 rounded-xl px-5 py-4" style={{ background: "#fff7ed", border: "1px solid #fed7aa" }}>
            ...
            <div>
              <p className="text-[12px] font-semibold text-orange-800 mb-0.5">Only this page is affected</p>
              <p className="text-[12px] text-orange-700 leading-relaxed">Your account and all other sections of the dashboard are working normally. No data was lost.</p>
            </div>
          </div>

          <p className="text-center mt-6 text-[11px]" style={{ color: "#94a3b8" }}>
            © 2026 GasAgency Enterprise Platform · Dashboard Error
          </p>
        </div>
      </div>
    </div>
