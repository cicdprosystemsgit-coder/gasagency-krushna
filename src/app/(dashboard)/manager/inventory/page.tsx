  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="View product catalog, stock analysis and stock received from godown"
      ...
      <div className="rounded-xl overflow-hidden" style={{ background: "#fff", border: "1px solid #E4E4E7", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        <div className="flex items-center gap-3 px-5 py-4" style={{ borderBottom: "1px solid #F4F4F5", background: "#FAFAFA" }}>
          ...
          <div>
            ...
            <p className="text-[12px]" style={{ color: "#71717A" }}>View your product catalog, stock analysis dashboard and pricing</p>
          </div>
        </div>
        <div className="p-5">
          <InventoryClient initialProducts={products} isAdmin={false} dashboardData={dashboardData} />
        </div>
      </div>
