...
export default async function StaffCommercialSalesPage() {
  ...
  return (
    <div>
      <PageHeader title="Commercial Sales" subtitle="Manage commercial customer deliveries" icon={<ShoppingCart className="w-5 h-5" />} />
