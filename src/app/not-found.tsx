...
import { MapPin, Home, ArrowLeft, Flame, Info } from "lucide-react";
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-lg">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              <MapPin className="w-10 h-10" style={{ color: "#0284c7" }} />
          ...
          <div className="rounded-2xl p-8 mb-6" style={{ background: "#ffffff", border: "1px solid #e2e8f0", boxShadow: "0 4px 24px -4px rgba(15,23,42,0.08)" }}>
            <div className="flex justify-center mb-4">
              ...
              >
                <MapPin className="w-3 h-3" /> Error 404
              </span>
            </div>
          ...
          <div className="flex items-start gap-3 rounded-xl px-5 py-4" style={{ background: "#eff6ff", border: "1px solid #bfdbfe" }}>
            ...
            <div>
              <p className="text-[12px] font-semibold text-blue-800 mb-0.5">Looking for a specific feature?</p>
              <p className="text-[12px] text-blue-700 leading-relaxed">
                Use the main navigation after signing in, or contact your administrator if you believe this is a mistake.
              </p>
            </div>
          </div>

          <p className="text-center mt-6 text-[11px]" style={{ color: "#94a3b8" }}>
            © 2026 GasAgency Enterprise Platform · Error 404
          </p>
        </div>
      </div>
    </div>
